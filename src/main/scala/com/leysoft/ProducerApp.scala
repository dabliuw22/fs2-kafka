...
object ProducerApp extends TaskApp {
  ...
  val serializer: Serializer[Task, Message] = Serializer.delegate[Task, Message](JsonSerde())
  val producerSettings: ProducerSettings[Task, String, Message] = ProducerSettings(
